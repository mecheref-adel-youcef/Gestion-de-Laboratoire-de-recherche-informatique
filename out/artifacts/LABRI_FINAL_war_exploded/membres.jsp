...
<head>
    <head>
        ...
        <style >
            body{
                background-image: url("images/info.jpg") repeat center;
            }
            #for{
                background-image: url("images/entre.jpg");
            }
...
<div class="col-md-6 col-lg-offset-3">
                ...
                <div class="col-lg-10 col-lg-offset-1" style="background-color:rgba(0,0,0,0.9)"><br><br> <%
                    ...
                    if(request.getParameter("recherche")!= null ){
                        resultSet = Select.query("(select distinct p.idpersonne,p.nom,p.prenom,p.photo from equipe e, personne p where e.idequipe = p.idequipe and e.idequipe is not null and (e.nom like \"%"+request.getParameter("recherche")+"%\" or e.fullname like \"%"+request.getParameter("recherche")+"%\" or e.description like \"%"+request.getParameter("recherche")+"%\" or p.nom like \"%"+request.getParameter("recherche")+"%\" or p.prenom like \"%"+request.getParameter("recherche")+"%\" or p.email like \"%"+request.getParameter("recherche")+"%\" or p.specialite like \"%"+request.getParameter("recherche")+"%\" or p.profession like \"%"+request.getParameter("recherche")+"%\")) UNION (select distinct p.idpersonne,p.nom,p.prenom,p.photo from equipe e, personne p where e.idequipe = p.relation and p.relation is not null and (e.nom like \"%"+request.getParameter("recherche")+"%\" or e.fullname like \"%"+request.getParameter("recherche")+"%\" or e.description like \"%"+request.getParameter("recherche")+"%\" or p.nom like \"%"+request.getParameter("recherche")+"%\" or p.prenom like \"%"+request.getParameter("recherche")+"%\" or p.email like \"%"+request.getParameter("recherche")+"%\" or p.specialite like \"%"+request.getParameter("recherche")+"%\" or p.profession like \"%"+request.getParameter("recherche")+"%\"));");
                    }else
                    {
                ...
                %>
                    <div class="col-sm-2" ><a href="profil.jsp?id=<%=resultSet.getString("idpersonne")%>"><img  class="img-thumbnail" src="<%=resultSet.getString("photo")%>" height="100px" width="100px" ></a><br>
                        <a style="color: #00b0ff" href="profil.jsp?id=<%=resultSet.getString("idpersonne")%>"><%=resultSet.getString("nom")%>
                            <%=resultSet.getString("prenom")%></a><br></div><%
                        }
