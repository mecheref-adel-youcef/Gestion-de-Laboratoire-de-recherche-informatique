                  ...
                  <div class="row">
                      <div class="col-md-6">
                          <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="titre" style="font-size: 18px" required >
                          </div> 
                        </div>  
                        </div>
                  <div class="col-md-3">
                      <div class="form-group">
                        ...
                        <div class="input-group date">
                          ...
                          <input type="text" name="dateDebut" class="form-control pull-right" id="datepicker" required>
                        </div>
                      </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                          ...
                          <div class="input-group date">
                            ...
                            <input type="text" name="dateFin" class="form-control pull-right" id="dp" required>
                          </div>
                        </div>
                    </div>  
                  </div>
          ...
          border: 1px solid rgb(221, 221, 221);
           padding: 0px; "></textarea>      
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <label>Lieu :</label>
                        <input type="text" name="laltitude" id="latitude" value="35.20891517251204" placeholder="latitude" hidden required>
                        <input type="text" name="longitude" id="longitude" value="-0.6333446502685547" placeholder="longitude" hidden required>
                        <div id="map" style="width:100%; height:255px"></div>
                        <input class="form-control" type="text" name="Lieu" style="font-size: 18px" required >
                    </div>
                </div> 
              </div>
