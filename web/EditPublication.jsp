...
<div class="container-fluid">
    <div class="row" >
      <div class="col-md-6"  style="border-right:solid 2px dodgerblue">
          ...
          <input type="hidden" name="id" value="${publication.getIdPublication()}" />
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input class="form-control" type="text" name="titre" style="font-size: 18px" value="${publication.getTitre()}" >
                </div> 
              </div>  
              </div>
            </div>
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <select name="Auteurs" class="form-control select2" multiple="multiple" data-placeholder="Entrer nom d'Auteur">
                   <c:forEach var ="temp" items="${publication.getAuteurs()}">
                   <option>${temp}</option>
                   </c:forEach>
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <div class="input-group date">
                    ...
                    <input type="text" name="date" class="form-control pull-right" id="datepicker" value="${publication.getDatePublication()}">
                  </div>
                </div>
              </div>
            </div>
            <div class="row">
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  style=" width: 100%; height: 200px; font-size: 20px ; line-height: 22px; border: 1px solid rgb(221, 221, 221); padding: 0px; display: ;" >${publication.getDescription()}
                  </textarea>      
                </div>
            </div>
          </div>
