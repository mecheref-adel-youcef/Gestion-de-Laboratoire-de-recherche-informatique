                  ...
                  <div class="row">
                      <div class="col-md-6">
                          <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="titre" value ="${Evenement.getTitre()}" style="font-size: 18px" required >
                          </div> 
                        </div>  
                        </div>
                  <div class="col-md-3">
                      <div class="form-group">
                        ...
                        <div class="input-group date">
                          ...
                          <input type="text" name="dateDebut" value="${Evenement.getDateDebut()}" class="form-control pull-right" id="datepicker" required>
                        </div>
                      </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                          ...
                          <div class="input-group date">
                            ...
                            <input type="text" name="dateFin" value="${Evenement.getDateFin()}" class="form-control pull-right" id="dp" required>
                          </div>
                        </div>
                    </div>  
                  </div>
...
<textarea class="textarea"  name="Description" 
          ...
          border: 1px solid rgb(221, 221, 221);
           padding: 0px; ">${Evenement.getDescription()}</textarea>      
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <label>Lieu :</label>
                        <input type="text" name="laltitude" id="latitude" value="${Evenement.getLatitude()}" placeholder="latitude" hidden required>
                        <input type="text" name="longitude" id="longitude" value="${Evenement.getLongitude()}" placeholder="longitude" hidden required>
                        <div id="map" style="width:100%; height:255px"></div>
                        <input class="form-control" type="text" name="Lieu" value="${Evenement.getLieu()}" style="font-size: 18px" required >
                    </div>
                </div> 
              </div>
                ...
                <div class="row">
                        <div class="col-md-12">
                        <button class="btn btn-info btn-lg btn-block active" type="submit"> Edit </button>
                        </div>
                      </div>
              </form>
