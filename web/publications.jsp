        ...
        <div class="col-lg-10 col-lg-offset-1" style="background-color:rgba(0,0,0,0.9)"><br><br>
            <table class="table">
                ...
                <tr style="color: #00b0ff">
                    <th>Titre</th><th>Date</th><th>Contenu</th></tr></thead>
                <%
                    String q = "select * from Publication ";
                    ResultSet resultSet;

                    resultSet = Select.query("select distinct La_Date ,Titre ,Contenu   from Publication ;");
                ...
                %>
                <tr><td style="color: #FFFFFF"><strong><%=resultSet.getString("Titre")%></strong></td><td style="color: #FFFFFF"><strong><%=resultSet.getString("La_Date")%></strong></td><td style="color: #FFFFFF"><%=resultSet.getString("Contenu")%></td><td></td> </tr>
                <%
